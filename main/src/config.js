...
export const CONFIG = {
    ...
    ENGINE: {
        ...
        NECROMANCER: {
            ...
            SHADOW_BLINK_SHAKE: 14,
            SHADOW_BLINK_PARTICLES: 20
        },
    ...
    CHARACTER_PROFILES: {
        ...
        char_3: {
            ...
            abilities: {
                ABILITY_1: { NAME: 'SHADOW BLINK', ICON: '\uD83D\uDC7B', COLOR: '#6c5ce7', MIN_LEVEL: 3, EFFECT: 'shadow_blink', DISTANCE: 260, EXPLOSION_RADIUS: 320, DAMAGE: 380 },
                ABILITY_2: { NAME: 'SOUL VORTEX', ICON: '\uD83C\uDF19', COLOR: '#2d1b69', MIN_LEVEL: 3, EFFECT: 'soul_vortex', DURATION: 3200, RADIUS: 9999, PULL: 1.9, DAMAGE: 99999 },
